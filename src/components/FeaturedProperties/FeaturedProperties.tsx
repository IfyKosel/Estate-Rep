...
const FeaturedProperties = () => {
  return (
    <div className="conatiner mx-auto border-b py-6 pb-10">
      ...
      <div className="flex flex-wrap">
        {FEATURED_PROPERTIES.map((property, index) => (
          <div
            key={index}
            className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 flex justify-center md:block"
          >
            <Link href="#" className="m-2 inline-block">
              <div className="p-8">
                <Image
                  className="mb-8 rounded object-cover"
                  src={property.image}
                  width={300}
                  height={300}
                  alt={property.name}
